<nav class="navbar navbar-expand-lg navbar-dark bg-info fixed-top">
  <div class="container">
    <a style="font-size: 30px" class="page-scroll oleo-font navbar-brand" href="#home">Good Laundry</a>
...
<section class="pt-5">
  <div class="jumbotron jumbotron-fluid bg-info">
    <div class="container text-white text-center">
      <img style="box-shadow: 5px 5px 5px rgba(0,0,0,0.3)" src="<?= base_url(); ?>assets/img/img_properties/GoodLaundry.png" alt="logo" class="img-fluid rounded mb-2" width="200">
      <h1 class="text-shadow display-4 oleo-font font-weight-bold">Good Laundry</h1>
	  <br><center><p>Postingan Oleh <a href='https://goodlaundry.com/' title='Goodlaundry.com' target='_blank'>GoodLaundry</a></p></center>
      ...
      <h5 class="text-shadow my-2">Namanya juga hidup pasti banyak <span class="font-weight-bold">Cobaan</span>, kalo banyak <span class="font-weight-bold">Cucian</span> bawa aja ke <span class="font-weight-bold oleo-font">Good Laundry.</span></h5>
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-lg-6 my-3">
		    	<h3 class="oleo-font">Good Laundry</h3>
		    	<div class="row">
		    		<div class="col-lg">
						<span>&copy; Copyright <?= date('Y'); ?> All rights Reserved with Good Laundry.</span>
		    		</div>
		    	</div>
			</div>
			<div class="col-lg-6 my-3">
        ...
        <div class="row text-left my-2">
          ...
          <div class="col-lg-5"><a class="text-white" target="_blank" href="https://api.whatsapp.com/send?phone=+6285932936891">+62 859 3293 6891</a></div>
        </div>
        ...
        <div class="row text-left my-2">
          ...
          <div class="col-lg-8">Jl. Bakung No.22, Dero, Condongcatur, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55281</div>
        </div>
      </div>
		</div>
		<div class="row">
			<div class="col-lg">
				<iframe class="rounded" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.330790369761!2d110.4092606!3d-7.7546969999999975!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a598d2dd4ffa7%3A0x75aca1fddefb7097!2sGood%20Laundry!5e0!3m2!1sen!2suk!4v1702186724242!5m2!1sen!2suk" height="300" frameborder="0" style="border:0; margin-top: 15px;width: 100%" allowfullscreen=""></iframe>
				</div>
		</div>
	</div>
</footer>
