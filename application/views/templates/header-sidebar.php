		...
		<div class="wrapper">
			...
			<nav id="sidebar">
			    <div class="sidebar-header">
			    	<img class="img-fluid" src="<?= base_url('assets/img/img_properties/GoodLaundry.png'); ?>" alt="logo">
			    </div>

			    <ul class="list-unstyled components">
			      <p class="bg-info my-0"><strong>Outlet</strong> : <?= $dataUser['nama_outlet']; ?></p>
			      <p class="bg-info my-0"><strong>Pengguna</strong> : <?= $dataUser['username']; ?></p>
			      <p class="bg-info my-0"><strong>Jabatan</strong> : <?= $dataUser['nama_jabatan']; ?></p>
			      <li>
			    ...
			    <ul class="list-unstyled">
			      <li>
			        <p>Hak Cipta 2023 &copy; Oleh Good Laundry</p>
			      </li>
			    </ul>
			</nav>
			    ...
			    <nav class="navbar navbar-expand-lg navbar-light bg-light">
			      <div class="container-fluid">
			        <button type="button" id="sidebarCollapse" class="btn btn-info">
			          <i class="fas fa-align-left"></i> | Postingan Oleh <a href='https://goodlaundry.com/' title='GoodLaundry.com' target='_blank'>GoodLaundry.com</a>
					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="logoutModalLabel">Keluar Aplikasi Good Laundry</h5>
